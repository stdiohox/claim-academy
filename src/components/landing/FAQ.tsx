...
const FAQS = [
  ...
  },
  {
    ...
    a: "The next cohort starts September 3, 2026 and runs 12 weeks: 4 weeks of live training (Mon/Wed/Fri, 60-minute sessions), then your guaranteed 8-week internship, ending November 26, 2026. Applications close September 3 — the same day the cohort starts. All sessions are recorded.",
    tag: "Schedule",
  },
  {
